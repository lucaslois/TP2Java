...
public class VenderPropiedadesController implements EventHandler<ActionEvent> {
    private Usuario usuario;
    private PlayerInformation panelInformacion;


    public VenderPropiedadesController(Usuario usuario, PlayerInformation panelInformacion) {
