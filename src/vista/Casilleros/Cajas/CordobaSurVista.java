...
public class CordobaSurVista extends CajaVista {

    public CordobaSurVista(Casillero casillero) {
        super(casillero);
        this.setImage(new Image("File:src/vista/assets/images/casilleros/Tablero_14.jpg"));
    }
    ...
    public void esCompradoPor(Jugador jugador) {
        ...
        JOptionPane.showMessageDialog(null, "Has comprado Cordoba Sur por $" + ((Comprable) this.casillero).getPrecio() + ".");
    }
}
