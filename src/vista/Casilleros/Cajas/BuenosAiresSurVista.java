...
public class BuenosAiresSurVista extends CajaVista {

    public BuenosAiresSurVista(Casillero casillero) {
        super(casillero);
        this.setImage(new Image("File:src/vista/assets/images/casilleros/Tablero_19.jpg"));
    }
    ...
    public void esCompradoPor(Jugador jugador) {
        ...
        JOptionPane.showMessageDialog(null, "Has comprado Buenos Aires Sur por $" + ((Comprable) this.casillero).getPrecio() + ".");
    }
}
