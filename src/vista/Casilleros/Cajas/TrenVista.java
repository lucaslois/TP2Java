...
public class TrenVista extends CajaVista {
    public TrenVista(Casillero casillero) {
        super(casillero);
        this.setImage(new Image("File:src/vista/assets/images/casilleros/Tablero_09.jpg"));
    }
    ...
    public void esCompradoPor(Jugador jugador) {
        ...
        JOptionPane.showMessageDialog(null, "Has comprado Tren por $" + ((Comprable) this.casillero).getPrecio() + ".");
    }
}
