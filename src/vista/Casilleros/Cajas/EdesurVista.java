...
public class EdesurVista extends CajaVista {

    public EdesurVista(Casillero casillero) {
        super(casillero);
        this.setImage(new Image("File:src/vista/assets/images/casilleros/Tablero_18.jpg"));
    }
    ...
    public void esCompradoPor(Jugador jugador) {
        ...
        JOptionPane.showMessageDialog(null, "Has comprado Edesur por $" + ((Comprable) this.casillero).getPrecio() + ".");
    }
}
