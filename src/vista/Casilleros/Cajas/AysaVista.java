...
public class AysaVista extends CajaVista {

    public AysaVista(Casillero casillero) {
        super(casillero);
        this.setImage(new Image("File:src/vista/assets/images/casilleros/Tablero_03.jpg"));
    }
    ...
    public void mostrarOpciones(Usuario usuario, PlayerInformation panelInformacion) {
        ...
        Comprable aysa = (Comprable) this.casillero;
        if(aysa.getPropietario() != null) {
    ...
    public void esCompradoPor(Jugador jugador) {
        ...
        JOptionPane.showMessageDialog(null, "Has comprado AySA por $" + ((Comprable) this.casillero).getPrecio() + ".");
    }
