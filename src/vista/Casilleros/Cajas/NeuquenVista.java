...
public class NeuquenVista extends CajaVista {
    public NeuquenVista(Casillero casillero) {
        super(casillero);
        this.setImage(new Image("File:src/vista/assets/images/casilleros/Tablero_11.jpg"));
    }
    ...
    public void esCompradoPor(Jugador jugador) {
        ...
        JOptionPane.showMessageDialog(null, "Has comprado Neuquen por $" + ((Comprable) this.casillero).getPrecio() + ".");
    }
}
