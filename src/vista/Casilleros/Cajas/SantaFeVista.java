...
public class SantaFeVista extends CajaVista {

    public SantaFeVista(Casillero casillero) {
        super(casillero);
        this.setImage(new Image("File:src/vista/assets/images/casilleros/Tablero_02.jpg"));
    }
    ...
    public void esCompradoPor(Jugador jugador) {
        ...
        JOptionPane.showMessageDialog(null, "Has comprado Santa Fe por $" + ((Comprable) this.casillero).getPrecio() + ".");
    }
}
