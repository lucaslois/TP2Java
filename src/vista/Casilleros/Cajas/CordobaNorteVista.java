...
public class CordobaNorteVista extends CajaVista {


    public CordobaNorteVista(Casillero casillero) {
        super(casillero);
        this.setImage(new Image("File:src/vista/assets/images/casilleros/Tablero_07.jpg"));
    }
