...
public class SaltaNorteVista extends CajaVista {

    public SaltaNorteVista(Casillero casillero) {
        super(casillero);
        this.setImage(new Image("File:src/vista/assets/images/casilleros/Tablero_04.jpg"));
    }
    ...
    public void esCompradoPor(Jugador jugador) {
        ...
        JOptionPane.showMessageDialog(null, "Has comprado Salta Norte por $" + ((Comprable) this.casillero).getPrecio() + ".");
    }
}
